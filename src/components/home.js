    ...
    <div className='home-card-container'>
      <Card className='home-card'>
        <CardContent>
          ...
          <Typography color="textSecondary"> A moment lasts all of a second, but the memory lives on forever. Memory is a way of holding on to the things you love, the things you are, the things you never want to lose.</Typography>
        </CardContent>
      </Card>
    </div>
